...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("কিস দিস না তোর মুখে দূর গন্ধ করে, কয়দিন ধরে দাঁত ব্রাশ করিস নাই🤬", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Hii") || (event.body.toLowerCase() == "hii") ||(event.body.toLowerCase() == "Hlw") || (event.body.toLowerCase() == "Hlw")) {
   ...
   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "mc")) {
     return api.sendMessage("তোর মারে তুই চোদ শুয়োরের বাচ্চা", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
     return api.sendMessage("GOOD MORNING দাত ব্রাশ করে খেয়ে নেও😚, , তোমার মুখে অনেক গন্ধ 🤢", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Rahad") || (event.body.toLowerCase() == "Rahad vai") || (event.body.toLowerCase() == "@Cyclopean C. Bladeッ") || (event.body.toLowerCase() == "Rahad")) {
     return api.sendMessage("উনি এখন হাত মারতে বিজি আছে, কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Rahad ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rahad.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://https://www.facebook.com/profile.php?id=61574627006558\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0174482****", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Rahad ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রাহাত আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rahad ッ❤️ তাকে সবাই উল্লাস নামে  চিনে🤙", threadID);
   };

   if ((event.body.toLowerCase() == "ai") || (event.body.toLowerCase() == "Ai")) {
     return api.sendMessage("তুই কে আমি আমার বস রাহাতে’র কথা শুনি", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami Rahad") || (event.body.toLowerCase() == "cup sala ami Rahad") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Katee Winslet ") || (event.body.toLowerCase() == "@Katee Winslet  ")) {
     return api.sendMessage("কেউ তাকে মেনশন দিবানা এটা, আমার বস রাহাত এর বউ এর আইডি 😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "annu") || (event.body.toLowerCase() == "annu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাহাত এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bby") || (event.body.toLowerCase() == "jaan")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রাহাত এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Cyclopean C. Conscrusher") || (event.body.toLowerCase() == "jamil")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস রাহাতে'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Bye") || (event.body.toLowerCase() == "gelam") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "😾")) {
     return api.sendMessage("️রাগ করে না সোনা পাখি এতো রাগ শরীরের জন্য ভালো না🥰, তোমার রাগ আমি চুষে খেয়ে ফেলবো🤭👉🏻👌🏻", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝙍𝙖𝙝𝙖𝙙 𝑯𝒆𝒍𝒑", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "@Umme Yaani") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️Kiss Randi Ka Name Le Ke Mood Khrab Kr Diya.🙄 Dubara Naam Mat Lena Iska. Nehi toh tumara gand Kath”ke tumara hat me de,donga", threadID);
   };

   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "tor nanire xudi")) {
     return api.sendMessage("️এত চোদা চুদি করস কেনো ? তোর আম্মুরে চোদ যা..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Rahad") || (event.body.toLowerCase() == "kire")) {
...
if ((event.body.toLowerCase() == "Tor nanir heda") || (event.body.toLowerCase() == "Tor nanir heda")) {
     return api.sendMessage("কেন তুই কী মাগি নাকি,থাপ্রায়ে তোর ভোদ ছিঁড়া ফালাইবো আমার বস রাহাত<🥵", threadID);
   };

if ((event.body.toLowerCase() == "@Umme Yaani") || (event.body.toLowerCase() == "umme")) {
     return api.sendMessage("আমার বস রাহাত তোমার কি হয়<🥵", threadID);
   };
